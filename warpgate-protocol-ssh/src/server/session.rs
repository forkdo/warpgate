    ...
    pub async fn start(
        ...
        Ok(async move {
            let result = loop {
                ...
                // inactivity_timeout of 0 means the timeout is disabled
                let inactivity_timeout = if inactivity_timeout.is_zero() {
                    None
                } else if matches!(this.target, TargetSelection::AwaitingApproval) {
                ...
                let next_event = match inactivity_timeout {
                    ...
                    // inactivity_timeout is 0 - the timeout is disabled
